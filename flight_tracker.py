    ...
    for item in report:
        ...
        if not flights:
            ...
            <tr style="background:#0d1423;font-size:11px;color:#6b7a99;text-transform:uppercase;letter-spacing:.08em">
              ...
              <td style="padding:8px">Depart &rarr; Arrive</td>
            ...
            for i, f in enumerate(flights):
                ...
                <tr style="background:{bg}">
                  <td style="padding:10px 16px;color:#e8f0fe;font-weight:600">{f['airline']}{badge}</td>
                  <td style="padding:10px 8px;color:#aaa;font-size:12px">{f['flight_num']}</td>
                  <td style="padding:10px 8px;color:#e8f0fe;font-weight:700;font-size:15px">{f['dep_time']} &rarr; {f['arr_time']}</td>
                  <td style="padding:10px 8px;color:#aaa;font-size:12px">{f['duration']}</td>
                  <td style="padding:10px 8px;color:#aaa;font-size:12px">{f['stops']}</td>
